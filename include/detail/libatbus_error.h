...
typedef enum {
    ...
    EN_ATBUS_ERR_CHANNEL_UNSUPPORTED_VERSION  = -106, // 通道版本不受支持
    EN_ATBUS_ERR_CHANNEL_ALIGN_SIZE_MISMATCH  = -107, // 对齐参数不一致
    EN_ATBUS_ERR_CHANNEL_ARCH_SIZE_T_MISMATCH = -108, // 架构size_t不匹配
